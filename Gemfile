...
gem 'pg', '>= 0.18', '< 2.0'
# if you see sqlite3 here that means pg is not installed 
...
group :development, :test do
  ...
  # makes your error msgs more readable
  gem 'better_errors' 
...
group :test do
  ...
  # gem 'capybara' # Specifically for integration testing, but already included by default
